...
write_csv(metadata, here("doc", "atac-seq", "combined", "merged_sra_run_tables.csv"))
```
...
```{r save peaks}
saveRDS(peak_list, here("dat", "atac-seq", "combined", "GRanges", "atac-seq_peak_list.RDS"))
saveRDS(peaks, here("dat", "atac-seq", "combined", "GRanges", "atac-seq_peaks_granges.RDS"))
```
...
saveRDS(peak_anno, 
        here("dat", "atac-seq", "combined", "GRanges", "atac-seq_peak_annotation.RDS"))
saveRDS(promoters, 
        here("dat", "atac-seq", "combined", "GRanges", "promoter_atac-seq_peak_annotation.RDS"))
saveRDS(noncoding, 
        here("dat", "atac-seq", "combined", "GRanges", "noncoding_atac-seq_peak_annotation.RDS"))
```
