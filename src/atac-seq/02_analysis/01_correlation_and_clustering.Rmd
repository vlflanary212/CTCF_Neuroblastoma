...
```{r load metadata}
metadata <- read_csv(here("doc", "atac-seq", "combined", "atac-seq_cell_line_metadata.csv"))
```
...
metadata <- write_csv(metadata, here("doc", "atac-seq", "combined", "metadata_with_clusters.csv"))
```
