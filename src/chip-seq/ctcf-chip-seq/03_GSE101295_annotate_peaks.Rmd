...
```{r save peak list}
saveRDS(peak_list, here("dat", "chip-seq", "GSE101295", 
...
# attempt 1
# txdb <- makeTxDbFromGFF("/data/project/sen-lab/genome/hg38/gencode.v22.annotation.gtf")

# attempt 2
# gtf <- readGFFAsGRanges("/data/project/sen-lab/genome/hg38/gencode.v22.annotation.gtf")
...
saveRDS(peaks, here("dat", "chip-seq", "GSE101295", 
                    "peaks", "GSE101295_formatted_peaks.RDS"))
```

## Annotated Peaks
```{r annotate peaks}
peak_anno <- annotatePeak(peaks, tssRegion=c(-3000, 3000),
                          TxDb=txdb, annoDb="org.Hs.eg.db")
```

```{r save annotated peaks}
saveRDS(peak_anno,here("dat", "chip-seq", "GSE101295", 
